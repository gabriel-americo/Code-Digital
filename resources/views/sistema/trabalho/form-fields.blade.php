<div class="form-body">
    ...
    <div class="form-group">
        @include('sistema.templates.formulario.input', ['label' => 'Serviço', 'input' => 'servico', 'attributes' => ['class' => 'form-control']])
    </div>
    <div class="form-group">
        @include('sistema.templates.formulario.input', ['label' => 'Data', 'input' => 'data', 'attributes' => ['class' => 'form-control']])
    </div>
    <div class="form-group ">
        ...
        <p class="help-block"> Coloque uma imagem PNG. (Logo)</p>
    </div>
    <div class="form-group ">
        <div class="fileinput fileinput-new" data-provides="fileinput">
            <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 158px; height: 150px;"> </div>
        ...
        <p class="help-block"> Coloque uma imagem PNG. (Destaque)</p>
    </div>
</div>